...
export default function SSBanner(props:Props) {
    ...
    return (
        <Link href={slides?.[index]?.href || ""} className={twMerge(['relative w-full aspect-[282/394] block bg-secondary rounded-xl overflow-hidden', props?.className])}>
