...
export default function AEBanner(props:Props) {
    ...
    return (
        <Link href={slides?.[index]?.href || ""} className={twMerge(['relative w-full aspect-[585/250] block bg-secondary rounded-xl overflow-hidden', props?.className])}>
