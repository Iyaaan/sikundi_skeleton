...
export default function TBanner(props:Props) {
    ...
    return (
        <div className='container px-4'>
            <Link href={slides?.[index]?.href || ""} className={twMerge(['relative w-full lg:aspect-[900/114] aspect-[1262/248] block bg-secondary rounded-xl overflow-hidden', props?.className])}>
