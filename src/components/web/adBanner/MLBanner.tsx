...
export default function MLBanner(props:Props) {
    ...
    return (
        <div className='container px-4'>
            <Link href={slides?.[index]?.href || ""} className={twMerge(['relative w-full aspect-[1262/248] block bg-secondary rounded-xl overflow-hidden', props?.className])}>
