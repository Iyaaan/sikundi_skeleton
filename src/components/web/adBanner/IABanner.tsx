...
export default function IABanner(props:Props) {
    ...
    return (
        <Link href={slides?.[index]?.href || ""} className={twMerge(['relative w-full aspect-[300/300] block bg-secondary rounded-xl overflow-hidden', props?.className])}>
