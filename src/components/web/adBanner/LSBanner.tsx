...
export default function LSBanner(props:Props) {
    ...
    return (
        <Link href={slides?.[index]?.href || ""} className={twMerge(['relative w-full aspect-[300/600] block bg-secondary rounded-xl overflow-hidden', props?.className])}>
